(function($, window, document, undefined) {
    ...
    var supportTouch = (function() {
        ...
        return test || navigator.maxTouchPoints > 0 || window.navigator.msMaxTouchPoints > 0;
    })();
    ...
    AbcScroll.prototype.updatePositions = function() {
        ...
        self.posList.sort(function(a, b) {
            return a.pos - b.pos;
        });
    };
    ...
    AbcScroll.prototype.setScroll = function(target) {
        ...
        var $target = $(target),
            _data = $target.data(),
            posObj = this.posList.find(function(item) {
                return item.alpha === _data.alpha;
            });
